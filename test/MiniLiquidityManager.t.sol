...
contract MiniLiquidityManager is Ownable, Pausable, ReentrancyGuard {
    ...
    function addLiquidity(
        ...
        uint256 amountBMin,
        uint256 deadline
    ) external nonReentrant whenNotPaused ensure(deadline) {
    ...
    function _refundDust(address token, uint256 amount) internal {
        ...
        emit DustRefunded(msg.sender, token, amount);
    }
}
